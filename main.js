...
let userInput = await inquirer.prompt([{
        name: "question1",
        type: "list",
        message: "Q:1.Which Operator is used to create an intersection type in Typescript?",
        choices: ['1.!', '2.&', '3.&&', '4.!!']
    },
    {
        name: "question2",
...
if (question1 === '2.&')
    marks += 10;
if (question2 === '1.collection of key value pair')
    marks += 10;
if (question3 === '3.push()')
    marks += 10;
if (question4 === '3.shift()')
    marks += 10;
if (question5 === '1.String')
    marks += 10;
console.log(marks);
function myAns() {
